...
(function() {
    ...
    function getCategory() {
        // Cerca la categoria dal title della pagina o meta tag
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', function() {
            // Aggiunge listener ai link Amazon (selettore ottimizzato)
            const amazonLinks = document.querySelectorAll('a.btn-amazon');

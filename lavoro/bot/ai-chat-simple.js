...
async function analyzeMessage(message) {
    ...
    const highPriorityKeywords = ['comprare', 'acquisto', 'acquistare', 'compra', 'voglio', 'desidero', 'cerco', 'serve', 'mi serve', 'ho bisogno', 'necessito', 'vorrei', 'mi piacerebbe', 'sto cercando', 'sta cercando', 'vuole', 'desidera', 'cerca', 'trovare', 'cercare', 'scoprire', 'vedere', 'guardare', 'vorrebbe', 'desidererebbe', 'cercherebbe', 'necessiterebbe', 'piacerebbe', 'starebbe cercando', 'devo cercare', 'voglio trovare', 'mi serve questo', 'mi serve quello', 'mi serve quell', 'mi serve quel', 'mi serve una', 'mi serve un', 'mi serve delle', 'mi serve dei', 'mi serve gli', 'devo trovare', 'devo comprare', 'devo acquistare', 'voglio comprare', 'voglio acquistare', 'desidero comprare', 'desidero acquistare', 'sto cercando un', 'sto cercando una', 'sto cercando delle', 'sto cercando dei', 'sto cercando gli', 'cerco un', 'cerco una', 'cerco delle', 'cerco dei', 'cerco gli', 'trovare un', 'trovare una', 'trovare delle', 'trovare dei', 'trovare gli', 'scoprire un', 'scoprire una', 'scoprire delle', 'scoprire dei', 'scoprire gli', 'vedere un', 'vedere una', 'vedere delle', 'vedere dei', 'vedere gli', 'guardare un', 'guardare una', 'guardare delle', 'guardare dei', 'guardare gli', 'vorrei un', 'vorrei una', 'vorrei delle', 'vorrei dei', 'vorrei gli', 'mi piacerebbe un', 'mi piacerebbe una', 'mi piacerebbe delle', 'mi piacerebbe dei', 'mi piacerebbe gli', 'ho bisogno di un', 'ho bisogno di una', 'ho bisogno di delle', 'ho bisogno di dei', 'ho bisogno di gli', 'necessito un', 'necessito una', 'necessito delle', 'necessito dei', 'necessito gli', 'mi occorre', 'mi occorrono', 'mi manca', 'mi mancano', 'cerco qualcosa', 'voglio qualcosa', 'desidero qualcosa', 'mi serve qualcosa', 'ho bisogno di qualcosa', 'necessito qualcosa', 'vorrei qualcosa', 'mi piacerebbe qualcosa', 'devo qualcosa', 'trovare qualcosa', 'scoprire qualcosa', 'vedere qualcosa', 'guardare qualcosa', 'sto cercando qualcosa', 'cercherei qualcosa', 'vorrei trovare', 'vorrei comprare', 'vorrei acquistare', 'desidererei comprare', 'desidererei acquistare', 'starebbe cercando un', 'starebbe cercando una', 'starebbe cercando qualcosa'];
